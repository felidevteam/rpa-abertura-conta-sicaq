...
import { CrotPage } from "./page/crot-page.js";
import { CreditCardPage } from "./page/credit-card-page.js";
import { CheckCrotAndCreditPage } from "./page/check-crot-and-credit-page.js";
...
export default {
    ...
    "app.queue.account-consumer": async c => {
        ...
        const accountService = await c.get("app.service.account")
